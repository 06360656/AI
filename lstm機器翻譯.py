...
Original file is located at
    https://colab.research.google.com/drive/12xs3Y1ZwOXgmxwbTBxrZV8QDaSw-n7dn

# 中翻英
"""

'''
https://github.com/mc6666/MyNeuralNetwork
...
data_path1 = 'cmn1.txt' #'fra-eng/fra.txt'
# Vectorize the data.
input_texts = []
target_texts = []
input_characters = set()
target_characters = set()
lines = open(data_path1, encoding ='utf8').read().split('\n')
...
for seq_index in range(100):
    ...
    print('正確字串:', target_texts[seq_index])
    try:
        print('Decoded sentence:', decoded_sentence)
        if (target_texts[seq_index].lstrip()==decoded_sentence):
          print('✅')
          count=count+1
        else :
          print('❌')
